...
//     }else {
//         (userNum % 2 == 0) ? alert("Your number is even") : alert("Your number is odd");
//         alert("Your number plus 100 is " + (Number(userNum) + 100));
//         (userNum >= 0) ? alert("Your number is positive") : alert("your number is negative");
//     }
// }
